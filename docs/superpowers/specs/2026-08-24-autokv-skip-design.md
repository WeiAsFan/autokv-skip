...
> **文档状态：v1.0 运行前历史设计。** 本文记录最初获批方案，不是运行 `8181c9a332ef6e9c` 的事实报告；其中的 R535、Docker、镜像、动态 scale 和固定 Auto-4 均不得覆盖实际产物。实际事实见 [v1.0 统一项目事实](../../v1.0/FACTS.zh-CN.md)，v2.0 另行设计且不追溯改写本文。
